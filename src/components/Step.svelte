...
cursor-pointer hover:border-violet-400 duration-250">
    <div class="bg-slate-950 grid place-items-center px-4 text-5xl md:text-6xl
    -mt-10 sm:-mt-12 md:-mt-14 lg:-mt-16 mx-auto duration-250">
        <i class={step.icon}></i>
    ...
    <div class="flex-1 flex justify-between gap-4 items-center">
        <div class="ml-auto cursor-pointer hover:text-slate-950 duration-250
        relative after:absoulte after:top-0 after:h-0 after:right-full
        after:w-full after:h-full after:bg-white after:duration-250 hover:after:translate-x-full 
